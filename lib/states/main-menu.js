...
MainMenu.enter = function enterMainMenuSync(ctx){
  ...
  $("#footMenu").find("li").bind("mousedown", function(){
    dmaf.tell('text_button_down')
  }).bind("mouseover", function(){
     dmaf.tell('text_button_over')
  })

  $("#socials").find("li").bind("mousedown", function(){
    dmaf.tell('small_button_down')
  }).bind("mouseover", function(){
     dmaf.tell('small_buttonn_over')
  })

  $("button").find("li").bind("mousedown", function(){
    dmaf.tell('button_down')
  }).bind("mouseover", function(){
    dmaf.tell('button_over')
  })
