...
Setup.enter = function(ctx){
  ...
  // start game paused
  if( ~location.search.indexOf('paused') ){
...
function setupBindings(ctx){
 ...
 /* keys.bind('up up down down left right left right b a enter', function() {
  ...
  keys.bind('f',function(){ settings.data.debugFireball = !settings.data.debugFireball })
  keys.bind('g',function(){ settings.data.debugGhostball = !settings.data.debugGhostball })
  keys.bind('b',function(){ settings.data.debugTimebomb = !settings.data.debugTimebomb })
  keys.bind('z',function(){ settings.data.debugDeathball = !settings.data.debugDeathball })
