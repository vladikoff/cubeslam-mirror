...
Setup.enter = function enterSetupSync(ctx){
  ...
  inputs.bind('f',function(){ settings.data.debugFireball = settings.data.debugFireball?false:true })
  inputs.bind('g',function(){ settings.data.debugGhostball = settings.data.debugGhostball?false:true  })
