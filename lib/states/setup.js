...
Setup.enter = function enterSetupSync(ctx){
  ...
  ctx.editor = new Editor(ctx.game.puppeteer,ctx.game.actions);
  ctx.game.puppeteer.on('added',ctx.editor.add.bind(ctx.editor));

  // add the available levels
  ctx.game.puppeteer.add(levels.level1);
  ctx.game.puppeteer.add(levels.level2);
  ctx.game.puppeteer.add(levels.level3);
  ctx.game.puppeteer.add(levels.level4);
  ctx.game.puppeteer.add(levels.level5);
  ctx.game.puppeteer.add(levels.level6);
  ctx.game.puppeteer.add(levels.level7);
  ctx.game.puppeteer.add(levels.level8);
