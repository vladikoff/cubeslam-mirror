...
Renderer.prototype = {
  setupAddedRemoved: function(worldName){
    ...
    this.onadded = function(type,world,body){
      ...
      switch(type){
        case 'extra':
          var obj = Extra.alloc().create(this.gamePiece(), body)
          this.extras.set(body.index,obj)
          break;
        case 'bullet':
         var obj = Bullet.alloc().create(this.gamePiece(), body, this);
          this.bullets.set(body.index,obj)
          break;
        case 'puck':
          var obj = Puck.alloc().create(this.gamePiece(), body, this);
        ...
        case 'shield':
          ...
          break;
        case 'force':
          var obj = createForce(this.gamePiece(), body)
