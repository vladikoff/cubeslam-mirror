...
Renderer.prototype = {
  ...
  render: function(world, alpha){
    ...
    if( world.paddles.has(world.me.paddle) ) {
      this.paddlePlayer.update(world.paddles.get(world.me.paddle), alpha)
      this.paddleCPU.update(world.paddles.get(world.opponent.paddle), alpha)
    }
