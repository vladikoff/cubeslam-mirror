...
Puck.prototype = {
  create: function(el, body){
    ...
    this.sprites = 31;
    var transform = 'rotateX(-90deg) translateX(361px) translateY(-50%) translateZ(505px) scale(1.5)';
  ...
  update: function(renderer, alpha){
    ...
    var transform = 'rotateX(-90deg) translateX('+(this.x-23)+'px) translateY(-50%) translateZ('+(this.y+23)+'px) scale(1.5)'
