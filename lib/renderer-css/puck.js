...
Puck.prototype = {
  ...
  update: function(renderer, alpha){
    ...
    if( puckBody.data.fireball ) {
      puckBody.data.fireball = toggleEffect(this,'fireball',puckBody.data.fireball)
    }
    // ghost (1=turn on, 2=turn off, undefined/0=ignore)
    if( puckBody.data.ghostball ) {
      puckBody.data.ghostball = toggleEffect(this,'ghostball',puckBody.data.ghostball)
    }
    ...
    if( puckBody.data.timebomb ) {
      ...
      puckBody.data.timebomb = toggleEffect(this,'timebomb',puckBody.data.timebomb)
    }
