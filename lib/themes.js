...
Themes.prototype = {
    ...
    goto: function(index) {
        ...
        if( index > this.list.length ) {
            while( index > this.list.length ) index -= this.list.length;
        }
        ...
        if(this.current.darken) {
           ...
           extras.find("li").addClass("ui-darken")
           ...
           extras.find("li").removeClass("ui-darken")
...
function Theme( mixin ) {
    ...
    this.darken = false
    this.countdown1 = 0xe83129
    this.countdown2 = 0x40a040
