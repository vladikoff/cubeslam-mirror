    ...
    switch(json.Type){
      ...
      case 'offer':
        ...
        connection.setRemoteDescription(desc,function(){
          sendAnswer();
        },function(err){console.error('could not set remote description from offer',desc.sdp,err,connection)});
        break;
      ...
      case 'answer':
        ...
        connection.setRemoteDescription(desc,function(){
        },function(err){console.error('could not set remote description from answer',desc.sdp,err,connection)});
        break;
