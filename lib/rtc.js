...
exports.servers = { iceServers: [{url: 'stun:stun.l.google.com:19302'}] };
exports.configuration = { optional: [{RtpDataChannels:true}] };
exports.connect = function(token,room,clientId){
  ...
  */
  ...
  function createConnection(){
    debug.connection('create',exports.configuration)
    var connection = rtc.connection = new PeerConnection(exports.servers,exports.configuration);
  ...
  // reconnect next tick to allow for
  // initial listeners
  nextTick(function(){ rtc.reconnect() })
