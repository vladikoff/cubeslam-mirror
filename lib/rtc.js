...
exports.connect = function(token,room){
  ...
  socket.onmessage = function(msg){
    ...
    switch(type){
      ...
      case 'connected': 
        debug('connected user',data,connection.localDescription)
        this.peer = data;
  ...
  connection.onstatechange = function(e){
    debug('connection statechange',arguments)
