...
function Collide(world, a, b, c){
  ...
  //take care of second part
  switch(b.id){
    case 'puck': return Collide.puck(world,b,a,c); break;
    case 'bullet': return Collide.bullet(world,b,a,c); break;
    case 'shield': return Collide.shield(world,b,a,c); break;
