var debug = require('debug').enable('game rtc:* inputs')
  , Game = require('./game')
  , rtc = require('./rtc')
...
var PlayState = {
  ...
  controls: function(inputs) {
    ...
    if( world.over ){
      world.paused = true;
      // TODO This is called ~8 times, why? the pause below should stop it...
      console.log('GAME OVER (in playstate), starting timeout')
