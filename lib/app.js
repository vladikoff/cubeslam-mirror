    ...
    $.ajax({
      ...
      success: function(data){
        ...
        this.remote.on('open',function(){
          ...
          if( game.isState(InviteFriendState) || game.isState(MainMenuState) ){
            if( world.host )
          ...
          if (this.opponentGameState != newState) {
            ...
            switch(this.opponentGameState){
              ...
              case 'WaitForFriendCamera':
                if( world.host && game.isState(WaitForFriendCameraState) )
...
var GameInstructionsState = {
  ...
  create: function() {
    ...
    var gameInstructions = $('#gameInstructions').removeClass('inactive');
