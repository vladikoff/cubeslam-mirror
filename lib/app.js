...
var PaddleSetupState = {
  ...
  create: function() {
    ...
    $(".state.PaddleSetup .keyboard").bind('click', function() {
  ...
  destroy: function() {
    ...
    $(".state.PaddleSetup .keyboard").unbind('click');
    this.game.inputs.unbind(this.game.inputs.SPACE);
  }
  ...
  create: function(){
    ...
    var OpponentIsReady = {
      ...
      letOpponentIn: function() {
        NetworkState.game.switchState(MultiState);
      },
      destroy: function(callback) {
  ...
  create: function() {
    ...
    $('.state.OpponentLeft .play').each(function() {
      $(this).bind('click', function() {
        PauseState.game.switchState(GameStartState);
      });
    });
