...
if(!window.console.time) window.console.time = window.console.timeEnd = function(){};
if(!window.console.profile) window.console.profile = function(){};
if(!window.console.group) window.console.group = window.console.groupEnd = window.console.groupCollapsed = function(){};
...
// to avoid using a popstate on
// reloading we only activate it after receiving the
// initial pushState
var initialState = history.state || {};
window.onpopstate = function(evt) {
  if( evt.state !== null && initialState.pathname !== evt.state.pathname ){
    see(evt.state.pathname);
  }
  initialState.pathname = null;
}
