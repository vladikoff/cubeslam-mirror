...
var InviteFriendState = {
  ...
  create: function(){
    ...
    $('.InviteFriend .backFromInvite').on('click',function(){
      ...
      this.game.switchState(this.nextState || MainMenuState);
...
var GameStartState = {
  ...
  create: function() {
    ...
    this.puppeteer.on('update', world.multiplayer ? this.multiplayer : this.singleplayer)
...
var PlayState = {
  ...
  create: function(){
    ...
    // multiplayer
      ...
      if( !this.host && ~window.location.href.indexOf('ai') ){
  ...
  create: function() {
    ...
    if( GameStartState.channel ){
      ...
      $('.state.Pause .playFriend').show().on('click', function(){
        ...
        InviteFriendState.nextState = PauseState
  ...
  create: function() {
    ...
    $('.state.OpponentLeft .play').each(function() {
     ...
     $('.state.OpponentLeft .playFriend').on('click', function(){
      ...
      //TODO this can be broken?
      InviteFriendState.nextState = MainMenuState
      this.game.switchState(InviteFriendState)
...
var GameOverState = {
  ...
  create: function() {
    ...
    $('#gameOverDialog .playFriend').on('click', function(){
      switch(NetworkState.opponentGameState){
        ...
        case 'WaitingFriend': // i am host
          ...
          break;
        default: // not yet connected (or connected friend is not waiting)
          InviteFriendState.nextState = GameOverState
          this.game.switchState(InviteFriendState)
      }
    }.bind(this));
    ...
    if( world.multiplayer) {
      ...
      if( world.winner == world.me ) {
         $("#gameOverTitle").attr("src","images/youwin.png");
      }
      else {
         $("#gameOverTitle").attr("src","images/your_friend_wins.png");
      }
    }
    else {
    ...
    this.timeout = setTimeout(function(){
      ...
      world.renderer.changeView("gameOver");
