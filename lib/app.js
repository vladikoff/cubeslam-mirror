var debug = require('debug').enable('game rtc:* ai actions')
  , Game = require('./game')
  , rtc = require('./rtc')
...
var MainMenuState = {
  ...
  create: function(){
    ...
    $('#mainmenu .playFriend, #gameOverDialog .playFriend').on('click', function(){
...
var GameStartState = {
  ...
  create: function() {
    ...
    if( levelIndex != -1){
      var level = window.location.href.charAt(levelIndex+6);
...
var GameOverState = {
  ...
  create: function() {
    ...
    //all this is written in MainMenuState, refactor?
