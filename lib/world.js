...
World.prototype.createBody = function(shape,x,y,flags){
  debug('%s create body',name,this.index)
...
World.prototype.releaseBody = function(body){
  debug('%s release body',name,body.index)
  body.removed = true
  return body;
}
...
World.prototype.destroyBody = function(body){
  debug('%s destroy body',name,body.index)
  if( !body.removed )
...
World.prototype.reset = function(){
  ...
  var resetScores = this.state === World.OVER || this.state === World.NEXT_LEVEL;
