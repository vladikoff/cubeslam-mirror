...
World.DEATH_BALL = 'deatch ball';   // level inactive, no controls, no physics, no network, score reset
...
World.prototype.reset = function(){
  ...
  console.log('reset world. state %s, reset scores?',this.state,resetScores)
