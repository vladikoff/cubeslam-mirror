...
exports.playerToggleBulletproof = function(world,playerID,extraIndex,active){
  ...
  if( active ){
    ...
    paddle.data.bulletproofIcon = extraIndex;
  } else {
...
exports.playerToggleLaser = function(world,playerID,extraIndex,active){
  var player = world.players[playerID]
    , paddle = world.paddles.get(player.paddle)
  ...
  if( active ){
    ...
    paddle.data.laserIcon = extraIndex;
