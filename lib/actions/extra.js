...
exports.resetExtraGhost = function(world, extraIndex){
  console.log('reset ghost',extraIndex)
...
exports.hitPuckExtra = function(world, puck, extra){
  ...
  switch(id){
    ...
    case 'ghostball':
      ...
      puck.data.ghostballTimeout = world.tick.setTimeout('puckToggleGhostball', duration, puck.index,extra.index)
      break;
    ...
    case 'bulletproof':
      ...
      if( player ){
        ...
        if( paddle.data.bulletproofIcon ){
          icons.remove(world,paddle.data.bulletproofIcon);
          delete paddle.data.bulletproofIcon;
        }

        actions.playerToggleBulletproof(world,playerID,extra.index,true);
        world.tick.clearTimeout(world.timeouts.bulletproof);
        world.timeouts.bulletproof = world.tick.setTimeout('playerToggleBulletproof', duration, playerID, extra.index, false)
      } else {
    ...
    case 'paddleresize':
      ...
      paddle.data.resizeTimeout = world.tick.setTimeout('playerTogglePaddleResize',duration, playerID, extra.index, false);
      break;
    ...
    case 'laser':
      ...
      // remove any old extra icons
      if( paddle.data.laserIcon ){
        icons.remove(world,paddle.data.laserIcon);
        delete paddle.data.resizeIcon;
      }
      ...
      actions.playerToggleLaser(world,playerID,extra.index,true)
      world.tick.clearTimeout(world.timeouts.laserTimeout)
      world.timeouts.laserTimeout = world.tick.setTimeout('playerToggleLaser',duration,playerID,extra.index,false);
      break;
