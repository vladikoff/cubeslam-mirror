...
exports.hitExtra = function(world, puck, extra){
  ...
  switch(id){
    ...
    case 'ghostball':
      ...
      if( puck.data.ghostballTimeout ) world.tick.clearTimeout(puck.data.ghostballTimeout);
      puck.data.ghostballTimeout = world.tick.setTimeout(function(puck){
      ...
      }.bind(null,puck), (data.duration || 7)*1000)
      break;
    ...
    case 'timebomb':
      ...
      }.bind(null,puck,data.radius || settings.data.arenaHeight / 2), 4000)
      break;
    ...
    case 'multiball':
      ...
      world.tick.setTimeout(function disableGhost(){
        ...
        //dont remove multiball since it will be cleared on next round
        // actions.emit('removeExtra',id,extra);
