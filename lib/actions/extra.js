  ...
  switch(extra.id){
    ...
    case 'mirrored controls':
      ...
      if( player === world.me ){
        ...
        //currently invert renderer so no need for invertion av controls
        settings.data.invertControls = settings.data.invertControls;
    ...
    case 'fog':
      ...
      paddle.data.fog = 1;
      tick.clearTimeout(paddle.data.fogTimeout);
      paddle.data.fogTimeout = tick.setTimeout(function(){
        paddle.data.fog = 0;
      },(extra.data.duration || 5)*1000)
