...
exports.hitPaddle = function(world,puck,paddle){
  ...
  if( paddle.index === world.me.paddle ){
    ...
    // console.log('%s %s opponent paddle hit at %s',world.name,world.frame,paddle.current[0],paddle.velocity[0])
  }
...
exports.movePaddle = function(world,paddleIndex,dx){
  ...
  paddle.acceleration[0] += settings.data.framerate/dx*0.01;
}
