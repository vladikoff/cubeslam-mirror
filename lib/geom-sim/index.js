  ...
  controls: function(inputs){
    if( !world.paused ){
      ...
      if( settings.data.inputType == "motion" && inputs.motion.moved ){
        ...
        if( inputs.down('left') ){
          world.keyboardSpeed += ( settings.data.keyboardSpeedMax*-1 - world.keyboardSpeed)*(1-settings.data.keyboardAccelerate);
          ...
          world.keyboardSpeed += ( settings.data.keyboardSpeedMax - world.keyboardSpeed)*(1-settings.data.keyboardAccelerate);
          var x = world.paddles[world.me.paddle].current[0] + world.keyboardSpeed;
          x /= settings.data.arenaWidth
          actions.paddleMove(world.me.paddle, world.host ? x : 1-x);
