...
Simulator.prototype = {
  ...
  createPaddle: function(id,x,y,w,h){
    ...
    var paddle = new Body(shapes.rect(w*aw,settings.data.puckRadius*8),x*aw,y*ah,Body.DYNAMIC | Body.BOUNCE | Body.STEER)
    paddle.id = id;
  ...
  create: function(){
    ...
    world.players.a.paddle = this.createPaddle(0,.5,1,.15,.08); // 0 means "top" (i.e. height*0)
    world.players.b.paddle = this.createPaddle(1,.5,0,.15,.08); // 1 means "bottom" (i.e. height*1)
