...
Simulator.prototype = {
  ...
  setup: function(){
    world.players.a.paddle = this.createPaddle(.5,1,.2,.02); // 0 means "top" (i.e. height*0)
    world.players.b.paddle = this.createPaddle(.5,0,.2,.02); // 1 means "bottom" (i.e. height*1)
