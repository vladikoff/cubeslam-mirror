...
Body.IMMOVABLE  = 1 << 0;  // formerly known as fixed
Body.GHOST      = 1 << 1;  // passes through anything that isn't IMMOVABLE

// STATIC (IMMOVABLE/FIXED) won't be pushed when hit
// DYNAMIC moves when hit
// GHOST passes through DYNAMIC bodies
