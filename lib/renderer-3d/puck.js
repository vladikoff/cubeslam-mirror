...
Puck.prototype = {
  ...
  update: function(world,alpha){
    ...
    this.mesh.position.x = ((this.body.current[0]+this.body.offset[0])*alpha + (this.body.previous[0]+this.body.offset[0])*(1-alpha)) - hw;
    this.mesh.position.z = ((this.body.current[1]+this.body.offset[1])*alpha + (this.body.previous[1]+this.body.offset[1])*(1-alpha)) - hh;
