...
Effects.prototype = {
  ...
  update: function(world,alpha){
    ...
    for (var i = world.shields.values.length - 1; i >= 0; i--) {
      ...
      if( shieldBody.data.bulletproof && shieldMesh.material.opacity <= 0.2) {
        shieldMesh.material.opacity += 0.05;
      }
      else if( !shieldBody.data.bulletproof && shieldMesh.material.opacity > 0.2) {
        shieldMesh.material.opacity -= 0.05;
      }
    }
