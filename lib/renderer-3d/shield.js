...
Shield.prototype = {
  ...
  add: function(parent,body,world){
  ...
  update: function(){
    ...
    var shields = this.world.players[this.body.data.player].shields;
  ...
  animateOut: function(){
    ...
    if( this.targetScale == 0.01 && Math.abs(this.targetScale - this.mesh.scale.y)<0.05) { 
      ...
      this.mesh.scale.y += (this.targetScale-this.mesh.scale.y)*0.2;
      raf( this.animateOut.bind(this) )
    }
  }
}
