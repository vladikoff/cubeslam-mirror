...
CameraController.prototype = {
  ...
  setState : function( state ) {
    ...
    if( state == "lobby" ) {
      ...
      this.cameraUpdateFunc = function(){
        ...
        this.hoverPos.y += (2000-this.hoverPos.y)/14;
        this.hoverPos.z += (Math.cos(-angle)*3000-this.hoverPos.z)/14;
        ...
        this.hoverTarget.z += (0-this.hoverTarget.z)/24;
  ...
  showIntro : function(){
      ...
      this.animatedPos.set(5300,200,-100);
      this.animatedTarget.set(4000, -600, 0);

      TweenMax.to(this.animatedPos, 6 , {
        delay:6,
        x: 3000,y: 700,z: -3000,
        ease:Sine.easeIn,
        onComplete: function(){
      ...
      TweenMax.to(this.animatedTarget, 6, {
        delay:4,
        x: 0,y: 0,z: 0,
        ease:Sine.easeInOut,
        onUpdate:function(){
