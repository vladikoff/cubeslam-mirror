      ...
      if( world.players.a.score < world.players.b.score) {
        //if player A wins
         winnerCameraTransition = { 
          start: { origin: new THREE.Vector3(300,400,0), target: new THREE.Vector3(0,200,2000) },
          end: { origin: new THREE.Vector3(-300,400,0), target: new THREE.Vector3(0,200,2000), time:6 }
        }
      }
      else {
        winnerCameraTransition = { 
