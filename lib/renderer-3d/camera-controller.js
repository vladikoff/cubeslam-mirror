...
function CameraController(env){
  ...
  this.gameOverData = [
    { 
      ...
      end: { origin: new THREE.Vector3(0,200,0), target: new THREE.Vector3(0,200,1000) }
    },
    { 
      start: { origin: new THREE.Vector3(1000,200,0), target: new THREE.Vector3(0,200,1000) },
      end: { origin: new THREE.Vector3(1000,1200,0), target: new THREE.Vector3(0,200,1000) }
    }
  ]
...
CameraController.prototype = {
  ...
  nextPosition : function() {
    var start = this.activeList[this.currentCameraIndex];
    this.camera.position = start.start.origin;
    this.target = start.start.target;
