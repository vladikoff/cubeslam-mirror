...
function CameraController(){
  ...
  var camera = new THREE.PerspectiveCamera( settings.data.cameraFov, 1, 10, 20000 );
      ...
      if( world.players.a.score < world.players.b.score) {
        //if player A wins
         winnerCameraTransition = {
          start: { origin: new THREE.Vector3(300,400,-1000), target: new THREE.Vector3(0,100,1000) },
          end: { origin: new THREE.Vector3(-300,400,-1000), target: new THREE.Vector3(0,100,1000), time:6 }
        }
      }
      else {
        winnerCameraTransition = {
