...
CameraController.prototype = {
  ...
  onWindowResize : function( evt ){
    ...
    this.aspectCompensationZ = (2000-w)*0.8//(1-w/1600)*1600;
  ...
  moveCamera : function(pointData){
    ...
    originCurrent.y += ((pointData.origin.y+this.aspectCompensationZ)-originCurrent.y)/14;
    originCurrent.z += ((pointData.origin.z+this.aspectCompensationZ)-originCurrent.z)/14;
