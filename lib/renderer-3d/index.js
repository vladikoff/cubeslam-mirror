...
function Renderer(canvas){
  ...
  this.shaders = {
    simple_vs: require('../shaders/simple_vertex'),
    shield_fs: require('../shaders/shield_fs'),
    arena_fs: require('../shaders/arena_fs'),
    arenaside_fs: require('../shaders/arenaside_fs'),
    cpu_fs: require('../shaders/cpu_fs'),
    extraicon_vs: require('../shaders/extraicon_vs'),
    extraicon_fs: require('../shaders/extraicon_fs')
  }
