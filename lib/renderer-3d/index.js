...
Renderer.prototype = {
  ...
  triggerEvent: function( id, paramObj ) {
    if( id == "hit") {
      ...
      Materials.paddleSetupBox[4].uniforms.time.value = 0.8;
      setTimeout(function(){ Materials.paddleSetupBox[4].uniforms.active.value = 2 }.bind(this),1000)
    }
  ...
  activePlayer: function(id){
    ...
    if( id == 0 ){
      ...
      this.players.a.cube.geometry.materials[4] = Materials.localVideo;
      this.players.b.cube.geometry.materials[4] = Materials.cpu;

      this.players.b.reflection.material = Materials.cpu;
      this.players.a.reflection.material = Materials.localVideo;
    ...
    // b
      ...
      this.players.a.cube.geometry.materials[4] = Materials.cpu;
      this.players.b.cube.geometry.materials[4] = Materials.localVideo;

      this.players.a.reflection.material = Materials.cpu;
      this.players.b.reflection.material = Materials.localVideo;
      //move these?
      this.players.a.cube.rotation.y = Math.PI;
      this.players.b.cube.rotation.y = 0;
  ...
  changeView : function( state , callback ) {
    ...
    if( state == "lobby") {
      ...
      Materials.paddleSetupBox[4].uniforms.active.value = 0;
      Materials.paddleSetupDecal.map.offset = new THREE.Vector2( (this.active.id==0)?0:0.25,0.5);
      ...
      Materials.paddleSetupBox[4].uniforms.active.value = camera.active?1:0;
...
function createPost(renderer,scene,camera) {
  ...
  var rtParameters = { format: THREE.RGBFormat, stencilBuffer: true };
