...
Renderer.prototype = {
  ...
  triggerEvent: function( id, paramObj ) {
    if( id == "hit") {
      ...
      this.materials.paddleSetupBox[4].uniforms.time.value = 0;
    }
    else if( id == "webcamEnabled") {
      this.materials.paddleSetupBox[4].uniforms.active.value = 1;
    }
  },
  ...
  render: function(world,alpha){
    ...
    */
    ...
    /*this.players.b.cube.visible=false;
    this.skyboxCamera.updateCubeMap( this.renderer, this.scene );
    this.players.b.cube.visible=true;
    */
...
function createSkyboxCamera(scene) {
  var mirrorCubeCamera = new THREE.CubeCamera( 100, 10000, 512 );
  mirrorCubeCamera.position = new THREE.Vector3(0,0,0);
  // mirrorCubeCamera.renderTarget.minFilter = THREE.LinearMipMapLinearFilter;
  scene.add( mirrorCubeCamera );
  return mirrorCubeCamera;
}
