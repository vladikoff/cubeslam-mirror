...
Renderer.prototype = {
  ...
  reset: function(){
    ...
    console.log( $('#scores li'), $('#scores li').length)
  },
      ...
      case 'hit':
        ...
        if( paramObj.player == "a" )
          this.cameraController.hit()
           ...
           this.players[paramObj.player].hit(paramObj.impactX/settings.data.arenaWidth);
  ...
  changeView : function( state , callback ) {
    ...
    switch(state){
      ...
      case 'play':
        ...
        //show shields
        setTimeout( function(){
          this.players.a.setShields(3);
          this.players.b.setShields(3);
        }.bind(this),2000)
  ...
  render: function(world,alpha){
    ...
    if (this.players) {
      if( world.players.a.paddle != -1 )
        this.players.a.update(world.players.a,world.paddles.get(world.players.a.paddle),alpha)
      if( world.players.b.paddle != -1 )
        this.players.b.update(world.players.b,world.paddles.get(world.players.b.paddle),alpha)
    }
    ...
    if( this.updateScore ){
      if(world.multiplayer) {
        $('#scores .multiplayer .player li:lt('+(2-world.me.score)+')').removeClass('active');
        $('#scores .multiplayer .opponent li:lt('+(2-world.opponent.score)+')').removeClass('active');
      } else {
        $('#scores .singleplayer .player li:gt('+(2-world.me.score)+')').removeClass('active');
        $('#scores .singleplayer .opponent li:gt('+(2-world.opponent.score)+')').removeClass('active');
      }
...
function createOverlay( camera ) {
  ...
  /*uvs[0][0].u = marginLeft;
  uvs[3][0].u = marginLeft;
  uvs[6][0].u = marginLeft;*/

  //uvs[1][0].u = marginLeft;
...
*/
  ...
  var face = uvs[4];
  face[0].u = marginLeft;
  face[0].v = marginRight;
  face[1].u = marginLeft;
  face[1].v = marginTop;
  face[2].u = marginBottom;
  face[2].v = marginTop;
  face[3].u = marginBottom;
  face[3].v = marginRight;
  ...
  face[0].v = 1;
  face[1].u = 0;
  face[1].v = marginRight;
  face[2].u = marginLeft;
  face[2].v = marginRight;
  face[3].u = marginLeft;
  face[3].v = 1;

  //top right
  face = uvs[2];
  face[0].u = marginBottom;
  face[0].v = 1;
  face[1].u = marginBottom;
  face[1].v = marginRight;
  face[2].u = 1;
  face[2].v = marginRight;
  face[3].u = 1;
