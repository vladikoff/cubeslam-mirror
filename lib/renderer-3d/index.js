...
Renderer.prototype = {
  ...
  triggerEvent: function( id, paramObj ) {
    ...
    switch(id){
      ...
      case 'mirrorEffect':
        ...
        this.mirrorEffectActive = paramObj.active;
        ...
        if( this.mirrorEffectActive ) {
          ...
          TweenMax.to( this.overlayMirror.rotation,0.5,{delay:0.1,y:Math.PI,onStart:function(){
            //this.overlay.material.visible = false;
          }.bind(this), 
          onComplete:function(){
            //this.overlay.material.visible = true;
            this.mirrorEffectAnimating = false;
          }.bind(this)})

          TweenMax.to( this.overlayMirror,0.25,{offsetZ: -80, onUpdateScope:this,onUpdate:this.positionMirrorPlane, onComplete:function(){
          ...
          TweenMax.to( this.overlayMirror.rotation,0.5,{delay:0.1,y:0,onStart:function(){
           // this.overlay.material.visible = false;
          }.bind(this), 
          onComplete:function(){
            //this.overlay.material.visible = true;
  ...
  render: function(world,alpha){
    ...
    if( this.cpu && this.currentState == "play" ){
