var debug = require('debug')('renderer:3d:core')
  ...
  // , ExtraIcons = require('./extra-icons')
...
function Renderer(canvas){
  ...
  // actions.on('extras changed', ExtraIcons.update)
  // actions.on('showExtra', ExtraIcons.update)
  // actions.on('removeExtra', ExtraIcons.update)
  // actions.on('activateExtra', ExtraIcons.update)
