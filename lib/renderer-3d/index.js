...
function createRenderer(canvas){
  ...
  var w = window.innerWidth
    , h = window.innerHeight - $('#footer').height();
  $('#game').height(h);
  var precision = "mediump";//settings.data.quality == settings.QUALITY_MOBILE ? "mediump":"highp";
  var renderer = new THREE.WebGLRenderer({canvas: canvas, antialias:settings.data.antialias, precision: precision});
