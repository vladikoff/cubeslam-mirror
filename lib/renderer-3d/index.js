...
Renderer.prototype = {
  ...
  changeView : function( state , callback ) {
    ...
    if( state == "lobby") {
      ...
      */
      //hide boxes
      this.players.a.setMaterial( Player.CubeMaterialIdle )
      this.players.b.setMaterial( Player.CubeMaterialIdle )
...
*/
      ...
      if(world.host ) {
        ...
        this.players.b.setMaterial( world.opponent ? Player.CubeMaterialRemote:Player.CubeMaterialCPU )
      }
      else {
        this.players.b.setMaterial( Player.CubeMaterialLocal, true ) 
        this.players.a.setMaterial( world.opponent ? Player.CubeMaterialRemote:Player.CubeMaterialCPU )
      }
