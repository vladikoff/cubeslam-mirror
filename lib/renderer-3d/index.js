...
Renderer.prototype = {
  ...
  triggerEvent: function( id, paramObj ) {
    if( id == "hit") {
      ...
      //this.materials.paddleSetupBox[4].uniforms.time.value = 1.8;
  ...
  changeView : function( state ) {
    ...
    else if( state == 'paddleColor' ){
      var c = paramObj.color;
      this.materials.colorPreview.color = new THREE.Color().setRGB(c[0]/255,c[1]/255,c[2]/255);
    }
