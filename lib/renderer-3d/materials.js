...
Materials.prototype.setMaxAnisotropy = function( value ) {
  ...
  this.shield[4].uniforms.tDecal.value.anisotropy = value;
}
...
Materials.prototype.update = function(world){
  ...
  // update arena score
  this.arenaGrid.uniforms.points.value.x = world.players.a.score;
  this.arenaGrid.uniforms.points.value.y = world.players.b.score;
