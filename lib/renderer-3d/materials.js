...
function createGradientPlane(){
  ...
  var shadowMaterial = new THREE.MeshBasicMaterial( { map: shadowTexture, transparent:false,depthWrite:false} );
...
function createShield() {
  var semiTrans1 = new THREE.MeshBasicMaterial({color:0xffffff,transparent:true, opacity:0.4});
  var semiTrans2 = new THREE.MeshBasicMaterial({color:0xffffff,transparent:true, opacity:0.2});
  /*var shieldMaterial = new THREE.MeshFaceMaterial([
    semiTrans1,
    semiTrans1,
    semiTrans1,
    semiTrans1,
