...
function createOverlayMirrorMaterial() {
  ...
  var miniSceneRenderTarget = new THREE.WebGLRenderTarget( 512, 512,  { minFilter: THREE.LinearLinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBFormat, useStencilBuffer:false } );
  miniSceneRenderTarget.generateMipmaps = false;

  return new THREE.MeshBasicMaterial( {color:0x999999,map:miniSceneRenderTarget,side:THREE.DoubleSide,transparent:true} );
