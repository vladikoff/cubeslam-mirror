...
CPU.prototype.loadCharacter = function( index ){
  ...
  var body = new THREE.Mesh( Geometry.cpu, new THREE.MeshLambertMaterial({map:THREE.ImageUtils.loadTexture("images/bear.jpg")}) );
  ...
  //hand?
  if( index == 1 ) {
    var pawMesh = new THREE.Mesh( Geometry.paw,  new THREE.MeshLambertMaterial({map:THREE.ImageUtils.loadTexture("images/paw.jpg")}) );
