...
BombSkin.prototype.attachToMesh = function( mesh ) {
  ...
  TweenMax.to(this.bombMesh.scale,1,{x:1,y:1,z:1, repeat:10});
...
function ResizeSkin() {
  ...
  var resizeGeo = new THREE.CubeGeometry(settings.data.unitSize,settings.data.unitSize,settings.data.unitSize);
