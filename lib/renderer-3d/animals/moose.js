...
Moose.prototype.next = function(){
  ...
  if( nextState == "walk") {
    ...
    TweenMax.to(this.mesh.position,1,{x:this.dummie.x,z:this.dummie.z, 
      ease: Linear.easeNone, 
      onUpdate: function(){
        var ray = new THREE.Ray( new THREE.Vector3(this.mesh.position.x, 200, this.mesh.position.z), new THREE.Vector3(0, -1, 0));
