...
function Bird( container, speed, path){
  ...
  TweenMax.to( this.dummie,1,{ speed: 4.2, overwrite:"none",onStart:function(){}, ease:Sine.easeInOut, repeat:-1,yoyo:true })
  TweenMax.to( this.dummie,0.75,{ y2:100, x2:100, overwrite:"none", ease:Cubic.easeInOut, repeat:-1,yoyo:true })
  ...
  /*for (var i = beziers.x.length - 1; i >= 0; i--) {
    line.geometry.vertices.push( new THREE.Vector3(beziers.x[i].a,beziers.y[i].b,beziers.z[i].c))
  };*/
