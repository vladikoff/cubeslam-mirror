...
*/
  ...
  var hemLight = new THREE.HemisphereLight(settings.data.dirlightColor, 0xeeeeee,0.7);
  ...
  var dirLight = new THREE.DirectionalLight(settings.data.dirlightColor,1.0);
  ...
  settings.emitter.on("lightsUpdated", function(){
    ...
    hemLight.color.setHex(settings.data.hemisphereLightColor);
  })
...
*/
  ...
  //distant terrain
  terrainMesh = createTerrainMesh(6000,2000,2505,20,20,new THREE.Color( 0x1f84d5),4,false, Materials.terrain2)
  ...
  terrainMesh = createTerrainMesh(4000,3000,8505,20,15,new THREE.Color( 0x195475 ),4,false, Materials.terrain3)
