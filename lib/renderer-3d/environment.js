...
function createExtra(arena, world, icons, extra){
  ...
  // extra is a polygon
    ...
    var shapeGeo = new THREE.ExtrudeGeometry( shape, { amount: settings.data.puckRadius*8 } )
...
function createMarker( arena ) {
  var shapeGeo = new THREE.CubeGeometry( 130,230,130 )
    , shapeMesh = new THREE.Mesh( shapeGeo, Materials.icon  );
