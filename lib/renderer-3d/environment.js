...
Environment.prototype = {
  ...
  update: function(world,alpha){
    ...
    for(var i=0; i < world.pucks.values.length; i++){
      ...
      if( mesh ){
        mesh.position.x = (puck.current[0]*alpha + puck.previous[0]*(1-alpha)) - hw + puck.offset[0];
        mesh.position.z = (puck.current[1]*alpha + puck.previous[1]*(1-alpha)) - hh + puck.offset[1];
