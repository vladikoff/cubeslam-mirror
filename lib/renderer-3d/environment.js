...
function createArena(renderer){
  ...
  var r = settings.data.puckRadius
    , w = settings.data.arenaWidth + r*2
    , h = w/16*9
    , hw = w*.5
    , hh = h*.5
    , d = settings.data.arenaHeight + r*2
...
*/
  ...
  terrainMesh = createTerrainMesh(4000,3000,8505,10,15,new THREE.Color( 0x195475 ),4,false)
