...
Player.CubeMaterialRemote = "cpu"
Player.CubeMaterialLocal = "cpu"
...
Player.prototype = {
  ...
  update: function(paddle,alpha){
    ...
    if( this.cpu ){
     // this.cpu.setPaddleX( this.paddle.position.x/settings.data.arenaWidth )
      this.time += 0.01;
...
function createReflectionPlane(renderer,id){
  ...
  var plane = new THREE.Mesh(planeGeo, Materials.cpu);
