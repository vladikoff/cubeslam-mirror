...
Player.prototype = {
  ...
  updatePaddle: function(paddle,alpha) {
    ...
    if (paddle) {
      ...
      this.paddle.scale.x += (((paddle.aabb[1] - paddle.aabb[3])/100)*this.paddleExtraSize-this.paddle.scale.x)*0.2;
...
function createIdlePlane(){
  ...
  var idlePlane = new THREE.Mesh( new THREE.CubeGeometry(w-20,h+1,7,1,1,1), Materials.arenaBorder);
