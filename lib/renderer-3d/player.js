...
Player.prototype = {
 ...
 //   var paddleDepth = settings.data.paddleDepth;
  ...
  hit : function(){
    ...
    TweenMax.to(this,0.1,{
      ...
      onComplete:function(){
        ...
        var impactPointX = Math.random();
        for (var i =0; i < totalPixelsDead; i++) {
          TweenMax.delayedCall( i*0.05, this.breakPixel, [impactPointX,i/totalPixelsDead*0.8] )
        };
  ...
  /*  brokenCtx.lineWidth = 1;
    ...
    brokenCtx.strokeStyle =  "rgba(128, 0, 0, 1)";
    brokenCtx.strokeRect(gridSizeX*indexX-0.5, 512/totalRows*indexY-0.5, gridSizeX, gridSizeY);

    brokenCtx.fillStyle =  "rgba(255, 0, 0, 1)";
    brokenCtx.fillRect(gridSizeX*indexX, 512/totalRows*indexY, gridSizeX, gridSizeY);

    brokenTexture.needsUpdate = true;
    */
  }
