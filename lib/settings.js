  ...
  "remembered": {
    ...
    "level2": {
      "0": {
        ...
        "puckColor": 15715846,
        "arenaColor": 1446161,
        "terrainColor1": 1450548,
        "terrainColor2": 2108212,
        "terrainColor3": 132101,
        "treeBranchColor": 264719
      }
    }
  },
  "closed": false,
...
function createLevelUI() {
    // dat.GUI is global, included in the HTML
    var gui = settings.levelGUI = new dat.GUI({ load: settings.levelData, autoPlace: false, preset:"level1" });
    gui.width = 332;

    gui.remember(settings.level);
   ...
   /* f = gui.addFolder('Obstacles');
    f.add(settings.level, 'obstacleTypes');
    f.add(settings.level, 'obstacleSpawnInTime');
    f.add(settings.level, 'obstacleSpawnOutTime');

    f = gui.addFolder('Extras');
    f.add(settings.level, 'extraTypes');
    f.add(settings.level, 'extraSpawnInTime');
    f.add(settings.level, 'extraSpawnOutTime');*/
