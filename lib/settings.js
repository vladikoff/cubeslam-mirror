var Emitter = require('emitter')
  , world = require('./world')
  , Geometry = require('./renderer-3d/geometry')
...
settings.createGenericUI = function() {
  ...
  f = gui.addFolder('Puck');
  f.add(settings.data, 'speedupMomentum').name('Add momentum');
  ...
  settings.data.spawnExtras['paddle resize'] = false
