...
f.add(settings.data, 'arenaColor').options("Blue","Green","Red","Yellow").name("Predefined arena colors").onChange(function(value){
    settings.data.arenaColor = settings.data.colorMap[value];
})
f.addColor(settings.data, 'ballColor').name("Ball Color").listen();
f.add(settings.data, 'ballColor').options("Blue","Green","Red","Yellow").name("Predefined arena colors").onChange(function(value){
    settings.data.ballColor = settings.data.colorMap[value];
})
