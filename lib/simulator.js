...
Simulator.prototype = {
  ...
  controls: function(inputs){
    ...
    */
    ...
    if( inputs.motionTracker.videoCanvas ){
      this.renderer.setVideoTexture(inputs.motionTracker.videoCanvas);
    }
  ...
  update: function(dt,t){
    ...
    this.width = settings.data.arenaWidth;
    this.height = settings.data.arenaHeight;
    this.bounds = new Rect(0,this.width,this.height,0);
