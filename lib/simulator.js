...
Simulator.prototype = {
  ...
  createPaddle: function(player,x,y,w){
  ...
  create: function(){
    ...
    this.createPaddle(this.world.players.a,.5,0); // 0 means "top" (i.e. height*0)
    this.createPaddle(this.world.players.b,.5,1); // 1 means "bottom" (i.e. height*1)
