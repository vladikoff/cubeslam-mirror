...
Simulator.prototype = {
  ...
  createPuck: function(){
    ...
    actions.puckPush(lastPuck.id, x, y)
  },
  ...
  create: function(){
    ...
    world.players.a.paddle = this.createPaddle(.5,0); // 0 means "top" (i.e. height*0)
    world.players.b.paddle = this.createPaddle(.5,1); // 1 means "bottom" (i.e. height*1)
