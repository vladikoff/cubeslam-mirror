...
Simulator.prototype = {
  ...
  createPuck: function(){
    ...
    actions.puckPush(lastPuck.id, 0, -250)
  },
  ...
  create: function(){
    ...
    world.players.a.paddle = this.createPaddle(.5,0.98,.2,.05); // 0 means "top" (i.e. height*0)
    world.players.b.paddle = this.createPaddle(.5,0.02,.2,.05); // 1 means "bottom" (i.e. height*1)
