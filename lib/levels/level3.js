...
module.exports = {
  ...
  extras: {
    ...
    positions: [
      /*{x: 200, y: 200},
      {x: 850, y: 1700},*/
      {x: settings.data.arenaWidth*.5, y: settings.data.arenaHeight*.5},
      /*{x: 200, y: 2000},
      {x: 1400, y: 200},
      {x: 1400, y: 2000}*/
    ]
  ...
  obstacles: [
    // 130 is where the centroid is calculated...
    {id: 'triangle-left', x: 100, y: settings.data.arenaHeight*.5},
    {id: 'triangle-right', x: settings.data.arenaWidth-100, y: settings.data.arenaHeight*.5}
  ]
}
