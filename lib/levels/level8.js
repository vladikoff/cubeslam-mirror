...
module.exports = {
  ...
  extras: {
    available: [
      ...
      {id: 'mirrored controls', duration: 10}
    ],
    // ~1700x2455
    positions: [
      {x: 200, y: 200},
  ...
  obstacles: [
    //{id: 'block-rect', size: [6,4], x: settings.data.unitSize*3, y: settings.data.arenaHeight*.5},
    //{id: 'block-rect', size: [6,4], x: settings.data.arenaWidth-settings.data.unitSize*3, y: settings.data.arenaHeight*.5},
    //{id: 'block-rect', size: [2,8], x: settings.data.arenaWidth*.5 - settings.data.unitSize*4, y: settings.data.arenaHeight*.5},
    //{id: 'block-rect', size: [2,8], x: settings.data.arenaWidth*.5 + settings.data.unitSize*4, y: settings.data.arenaHeight*.5}
