...
module.exports = {
  ...
  obstacles: [
   ...
   {id: 'block-rect', size: [2,2], x: settings.data.unitSize*4, y: settings.data.arenaHeight*.5 + settings.data.unitSize*7},
   {id: 'block-rect', size: [2,2], x: settings.data.arenaWidth*.5, y: settings.data.arenaHeight*.5},
   {id: 'block-rect', size: [2,2], x: settings.data.arenaWidth - settings.data.unitSize*4, y: settings.data.arenaHeight*.5 - settings.data.unitSize*7}
