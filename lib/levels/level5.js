...
module.exports = {
  ...
  obstacles: [
   ...
   /*{id: 'block-rect', size: [2,2], x: settings.data.unitSize, y: settings.data.arenaHeight*.5},
   {id: 'block-rect', size: [2,2], x: settings.data.unitSize*9, y: settings.data.arenaHeight*.5},
   {id: 'block-rect', size: [2,2], x: settings.data.unitSize*17, y: settings.data.arenaHeight*.5}
*/
  ],

  forces: [
    { type: 'attract', x: settings.data.arenaWidth*.75, y: settings.data.arenaHeight*.25, mass: 600 },
    { type: 'attract', x: settings.data.arenaWidth*.5, y: settings.data.arenaHeight*.5, mass: 800 },
    { type: 'attract', x: settings.data.arenaWidth*.25, y: settings.data.arenaHeight*.75, mass: 600 }
  ]
}
