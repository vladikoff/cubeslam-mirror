...
module.exports = {
  ...
  obstacles: [
   ...
   {id: 'block-rect-2x2', x: settings.data.unitSize, y: settings.data.arenaHeight*.5},
   {id: 'block-rect-2x2', x: settings.data.unitSize*9, y: settings.data.arenaHeight*.5},
   {id: 'block-rect-2x2', x: settings.data.unitSize*17, y: settings.data.arenaHeight*.5}
