...
module.exports = {
  ...
  obstacles: [
    {id: 'block-rect', size: [8,1], x: settings.data.unitSize*4, y: settings.data.arenaHeight*.5 + settings.data.unitSize*8},
    {id: 'block-rect', size: [8,1], x: settings.data.arenaWidth - settings.data.unitSize*4, y: settings.data.arenaHeight*.5 - settings.data.unitSize*8}
  ]
}
