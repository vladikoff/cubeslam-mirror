...
module.exports = {
  ...
  obstacles: [
    {id: 'block-rect-8x1', x: settings.data.unitSize*4, y: settings.data.arenaHeight*.5 + settings.data.unitSize*8},
    {id: 'block-rect-8x1', x: settings.data.arenaWidth - settings.data.unitSize*4, y: settings.data.arenaHeight*.5 - settings.data.unitSize*8}
  ]
}
