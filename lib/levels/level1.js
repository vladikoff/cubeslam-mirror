...
module.exports = {
  ...
  extras: {
    available: [
      ...
      // {id: 'mirrored controls', duration: 5}, // duration in seconds
      // {id: 'random'},
      // {id: 'fog', duration: 10},
      // {id: 'extra life', round:2},
      // {id: 'ghost ball'},
      // {id: 'fireball'},
      // {id: 'time bomb', time: 5, radius: 0}, // time in seconds (radius defaults to half the arena)
      // {id: 'multiball'},
      {id: 'laser', duration: 3}, // duration defaults to 10s
      // {id: 'paddle resize',duration:3} // duration defaults to 10s
      // {id: 'death ball',duration:5}
    ],
    // ~1700x2455
    positions: [
      // {x: 200, y: 200},
