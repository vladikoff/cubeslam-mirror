...
module.exports = {
  ...
  // the kind can be either 'repell' or 'attract'
  forces: [
   // { kind: 'repell', x: settings.data.arenaWidth*.25, y: settings.data.arenaHeight*.25, mass: 500 },
   // { kind: 'attract', x: settings.data.arenaWidth*.75, y: settings.data.arenaHeight*.75, mass: 1000 }
  ]
}
