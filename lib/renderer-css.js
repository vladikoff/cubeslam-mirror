...
var puck = $('<div class="puck puck-15"><div class="gfx"></div></div>')
...
function createObstacle(world,body){
  ...
  switch(id) {
    case 'triangle-right':
    case 'triangle-left':
      obstacle = $('.obstacle.'+body.data.id)
      break;
    default: 
      throw new Error('unsupported obstacle: '+id)
  }
  return obstacle.show()[0];
}
