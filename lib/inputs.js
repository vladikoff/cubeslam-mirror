...
Inputs.prototype = {
  ...
  getUserMedia: function(options){
    ...
    if (navigator.getUserMedia) {
      navigator.getUserMedia(options, onUserMediaSuccess.bind(this), onUserMediaError.bind(this));
    
    // webkit users
    } else if (navigator.webkitGetUserMedia) {
      is_webkit = true;
      navigator.webkitGetUserMedia(options, onUserMediaSuccess.bind(this), onUserMediaError.bind(this));
