...
var AudioContextNS = window.AudioContext || window.webkitAudioContext || window.mozAudioContext;
...
audio.init = function(soundList) {
    ...
    /*try {
        ...
        var testContext = new AudioContextNS();
        //testContext.createBuffer()
...
audio.play = function(id) {
    ...
    if( audio.isAvailable ) {
        ...
        if( sample ) {
            ...
            console.warn('tried to play a sample that does not exist:',id)
        }
    }*/
};
...
function SoundFX() {
    /*
    this.loaded = false;
    this.context = new AudioContextNS();
...
SoundFX.prototype.stop = function() { /*this.source.noteOff(0);*/
};
...
SoundFX.prototype.load = function(url) {
    ...
    request.onload = function(e) {
        ...
        if(scope.context.decodeAudioData) {
            ...
            scope.source.buffer = scope.context.createBuffer(this.response, true);
        }
    }
