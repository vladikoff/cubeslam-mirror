...
Renderer.prototype = {
  ...
  createLights: function(){
    ...
    var pointLight = new THREE.PointLight( 0xFFFFFF,1.4,2000 );
...
*/
    var pointLight2 = new THREE.PointLight( 0xFFFFFF , 2, 2000 );
  ...
  createArena: function(){
    var w = this.bounds.r-this.bounds.l+this.ballRadius*2
      ...
      , arenaPosZ = 0//;d*.5
      , sideH = 150
      , transArenaMaterial = new THREE.MeshPhongMaterial({color:0xdd0000, opacity:0.9,transparent:true})
