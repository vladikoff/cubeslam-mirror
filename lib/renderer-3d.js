...
Renderer.prototype = {
  ...
  render: function(alpha){
    ...
    this.ballMesh.position.x = lerp(this.ballMesh.position.x, puck.current.x-(this.bounds.r-this.bounds.l)/2, alpha);
    this.ballMesh.position.z = lerp(this.ballMesh.position.z, puck.current.y-(this.bounds.b-this.bounds.t)/2, alpha);
    ...
    if( this.forces.length > this.forceMeshes.length ){
      for(var i=this.forceMeshes.length; i < this.forces.length; i++ ){
        ...
        forceMesh.position.x = force.x-(this.bounds.r-this.bounds.l)/2
        forceMesh.position.z = force.y-(this.bounds.b-this.bounds.t)/2
