...
Renderer.prototype = {
  ...
  createArena: function(){
    ...
    console.log(document.getElementById("remoteInput"))
  ...
  setVideoTexture : function(canvas) {
    ...
    if( !this.videoInitiated ) {
      ...
      var anim = new TWEEN.Tween(this.playerB.cubeMesh.position)
        ...
        .onComplete(function(){
          //scope.playerB.cubeVideoMaterial.map = scope.videoMaterialTexture;
          //scope.playerB.cubeVideoMaterial.needsUpdate = true;
