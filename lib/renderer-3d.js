...
Renderer.prototype = {
  ...
  createPaddles: function(){
    ...
    opponentPaddle.position.z = settings.data.arenaHeight*.5-settings.data.paddleDepth*.5;
  ...
  createLights: function(){
    ...
    dirLight.position = new THREE.Vector3(3000,1000,3000);
  ...
  render: function(world, alpha){
    ...
    if( this.playerA.shieldUniforms.uBrightness.value > 0.4 ) 
      this.playerA.shieldUniforms.uBrightness.value *= 0.98;
    if( this.playerB.shieldUniforms.uBrightness.value > 0.4 ) 
      this.playerB.shieldUniforms.uBrightness.value *= 0.98;
  ...
  updateHits : function(world){
    ...
    var hostHits = world.players.a.hits;
    ...
    var guestHits = world.players.b.hits;
