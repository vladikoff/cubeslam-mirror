...
Renderer.prototype = {
  ...
  createTerrain: function(){
      ...
      loader.load("models/terrain1.js", this.terrainLoaded.bind(this));     
  ...
  terrainLoaded : function(geometry) {
      ...
      for (var i = 0; i < len; i++) {
        ...
        point.y = n * 200 * (Math.abs(uvX*uvX)) * (uvY) - uvY*400// + n*400*((1-Math.abs(uvX))*(uvY))
