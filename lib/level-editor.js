  ...
  change: function(action){
    ...
    switch(action){
      ...
      case 'forceCreate':
        ...
        p.push(f.add(this.event.params,'2').min(0).max(settings.data.arenaWidth).name('Y').onChange( function(){onMarkerPosition(this.event.params)}.bind(this) ))
      ...
      case 'extraCreate':
        ...
        p.push(f.add(this.event.params,'1').min(0).max(settings.data.arenaWidth).name('X').step(1).onChange( function(){onMarkerPosition(this.event.params)}.bind(this) ))
        p.push(f.add(this.event.params,'2').min(0).max(settings.data.arenaHeight).name('Y').step(1).onChange( function(){onMarkerPosition(this.event.params)}.bind(this) ))
        break;
