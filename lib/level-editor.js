  ...
  change: function(action){
    ...
    switch(action){
      ...
      case 'forceCreate':
        ...
        p.push(f.add(this.event.params,'1').min( settings.data.unitSize*.5).max(settings.data.arenaWidth-settings.data.unitSize*.5).step(settings.data.unitSize).name('X').onChange( function(){onMarkerPosition(this.event.params)}.bind(this) ))
        p.push(f.add(this.event.params,'2').min( settings.data.unitSize*.5).max(settings.data.arenaWidth).name('Y').onChange( function(){onMarkerPosition(this.event.params)}.bind(this) ))
      ...
      case 'extraCreate':
        ...
        p.push(f.add(this.event.params,'1').min(settings.data.unitSize*.5).max(settings.data.arenaWidth-settings.data.unitSize*.5).name('X').step(settings.data.unitSize).onChange( function(){onMarkerPosition(this.event.params)}.bind(this) ))
        p.push(f.add(this.event.params,'2').min(settings.data.unitSize*.5).max(settings.data.arenaHeight-settings.data.unitSize*.5).name('Y').step(settings.data.unitSize).onChange( function(){onMarkerPosition(this.event.params)}.bind(this) ))
        break;
