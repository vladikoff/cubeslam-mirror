...
Renderer.prototype = {
  ...
  drawForce: function(ctx, force){
    ...
    var grad = ctx.createRadialGradient(x*w,y*h,0,x*w,y*h,r);
    ...
    ctx.fillStyle = grad;
    ctx.fillRect(x*w-r,y*h-r,force.mass*m,force.mass*m)
    console.log('draw force',x*w-r,y*h-r,force.mass*m,force.mass*m)
    this.stats.forces++;
  },
