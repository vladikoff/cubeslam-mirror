...
Network.prototype.close = function(){
  ...
  this.winner = false;
  this.sync.stop()
  this.network.emit('change connected',false)
  this.network.emit('change multiplayer',false)
  this.network.remote.close()
...
function netchan(channel,network,skipBase64){
  ...
  // return channel;
  return new NetChannel(channel,{resend: 50, ack: true})
}
