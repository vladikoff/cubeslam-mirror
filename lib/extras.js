...
exports.fastball = new Body(shapes.rect(aw/20,aw/20))
...
exports.fog.id = 'fog'
exports.extralife = new Body(shapes.rect(aw/20,aw/20))
...
for(var x=0; x < 10; x++){
  for(var y=0; y < 10; y++){
    ...
    block.flags = Body.STATIC | Body.BOUNCE | Body.DESTROY | Body.REFLECT;
    block.id = 'block-'+x+'-'+y;
