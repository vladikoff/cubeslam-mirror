...
Collide.puck = function(world, p, q, c){
  debug.collide('puck',p.index,Body.flags(p._flags),' > ',q.index,Body.flags(q._flags));
  console.log('collision in %s frame %s',world.name,world.frame)
