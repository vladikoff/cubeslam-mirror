        ...
        updateActivePatterns: {
            value: function () {
                ...
                while (i--) {
                    ...
                    if (addPosition.bar === this.songPosition.bar &&
                        addPosition.beat === this.songPosition.beat) {
                ...
                while (i--) {
                    ...
                    if (removePosition.bar === this.songPosition.bar &&
                        removePosition.beat === this.songPosition.beat) {
